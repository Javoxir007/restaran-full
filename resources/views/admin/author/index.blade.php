        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin/author/create') }}" class="btn btn-outline-success">Yangi qo`shish</a>
                </div>
                          ...
                          @foreach($authors as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin/author/edit', $item->id) }}" class="btn btn-primary">O`zgartirish</a>
                                </td>
                                <td class="text-center"> 
