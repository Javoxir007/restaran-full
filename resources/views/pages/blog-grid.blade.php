    ...
    <body class="header-1">
                    ...
                    <div class="primary-header-inner">
                        ...
                        <div class="header-menu-wrap">
                            <ul class="slider-menu">
                                ...
                                <li><a href="blog-grid.html#">Pages</a>
                                    <ul>
        ...
        <div id="popup-search-box">
            <div class="box-inner-wrap d-flex align-items-center">
                <form id="form" action="blog-grid.html#" method="get" role="search">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 sm-padding">
                            <div class="footer-widget">
                                <a class="logo" href="blog-grid.html#"><img src="assets/img/logo-dark.png" alt="img"></a>
                                <p>Financial experts support or help you to to find out which way you can raise your funds more.</p>
                                <ul class="footer-social">
                                    <li><a href="blog-grid.html#"><i class="fab fa-facebook"></i></a></li>
                                    <li><a href="blog-grid.html#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="blog-grid.html#"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="blog-grid.html#"><i class="fab fa-pinterest"></i></a></li>
                                </ul>
                            </div>
                        </div>
